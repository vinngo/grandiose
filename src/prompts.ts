...
export const prompts = [
  {
    ...
    items: [
      ...
      { id: "q41", text: "Cropped a blank tee?"},
      { id: "q42", text: "Made any modifications to your clothing and called it 'upcycling'?"},
      { id: "q43", text: "Worn a carabiner?"},
      { id: "q44", text: "Worn a tote/messenger bag?"},
      { id: "q45", text: "Referred to any article of clothing as a 'piece' or any jean as 'denim'?"},
      { id: "q46", text: "Done research on archive fashion knowing you can't afford any of it?"},
      { id: "q47", text: "DM'ed someone on vanish mode?"},
      { id: "q48", text: "Stressed over a follower to following ratio?"},
      { id: "q49", text: "Used an iPhone 5 or wired headphones for the aesthetic?"},
      { id: "q50", text: "Changed your outward demeanor in the presence of a MPS?"},
    ],
  },
]
